...
dataDict = ["03-01","03-02","03-03"]
for data in range(len(dataDict)):

    url="http://flights.ctrip.com/domesticsearch/search/SearchFirstRouteFlights?DCity1=SHA&ACity1=CTU&SearchType=S&DDate1=2018-"+dataDict[data]
    ...
    for eachinfo in jsondata["fis"]:
        ...
        if (transfer):
            basicInfo = dict(basicInfo, **transfer)
