...
for m in range(6):
    ...
    html_data = html.xpath(
        '/html/body/div[1]/div[5]/div[2]/div[2]/div/ul/li/a/@href')
    for i in html_data:
        ...
        teacher_name = html_temp.xpath(
            '/html/body/div[1]/div[5]/div[2]/div[2]/div/h3/text()')
        print(teacher_name[0])

        html_data_temp = html_temp.xpath(
            '//div[@class="wp_articlecontent"]/p/span')
        strinfo = ""
